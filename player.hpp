...
class Player : public Entity {
	...
	public:
		Player(Rectangle start_pos, int start_hp, int start_atk, float start_speed, const Map& m) : Entity{start_pos, start_hp, start_atk, start_speed, m} {
...
inline void Player::update(float& delta, std::vector<std::unique_ptr<Entity>>& entities) {
